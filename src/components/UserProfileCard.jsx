...
export default function UserProfileCard() {
  ...
  const name = user
    ...
    : defaultProfile.name;
  const headline = user
    ? "Full Stack Engineer & React Enthusiast"
  ...
  return (
    <div className="premium-card p-0 hover-lift">
      ...
      <div
        className="px-3 pb-3 border-bottom d-flex align-items-center gap-2"
      ...
      <div className="p-3 border-bottom">
        <div className="profile-card-stat">
          ...
          <span className="profile-card-stat-val">
            {defaultProfile.viewersCount}
          </span>
        </div>
        <div className="profile-card-stat">
          <span className="profile-card-stat-label">Post impressions</span>
          <span className="profile-card-stat-val">
            {defaultProfile.postImpressions}
          </span>
        </div>
        <a
          href="#analytics"
      ...
      <div
        className="p-3 border-bottom bg-light bg-gradient"
        style={{ fontSize: "11px" }}
      >
        <div className="text-muted">Access exclusive tools & insights</div>
        <a
          href="#premium"
          className="text-decoration-none fw-bold d-block text-dark hover-underline"
        >
      ...
      <div className="p-2" style={{ fontSize: "12px" }}>
        <a
          href="#saved"
          className="d-flex align-items-center gap-2 p-2 text-decoration-none text-dark hover-bg rounded"
        >
